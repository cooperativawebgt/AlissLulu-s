...
const comandos = {
    ...
    "quién te creo": () => {
        voz("El desarrollador JSathan Byron");
    },

    "qué eres": () => {
        voz("soy el asistente virtual de AlissLulu's");
    },

    "cuál es tu nombre": () => {
        voz("mi nombre es Edith");
    },
    ...
    "busca *busqueda": busqueda => {
        ...
        google.open("https://www.google.com/search?q=" + busqueda)
    },
    
    "quiero escuchar *busqueda": busqueda => {
        voz("ok, buscando " + busqueda + "para ti");
        google.open("https://www.youtube.com/results?search_query=" + busqueda)
    },
